...
`python -m efficient_word.generate_reference`
"""
import os , glob
import numpy as np
import json
from efficient_word.package_installation_scripts import check_install_librosa
from efficient_word.audio_processing import (
    ModelType,
    MODEL_TYPE_MAPPER
)
